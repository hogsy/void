...
# ADD LINK32 version.lib kernel32.lib user32.lib gdi32.lib shell32.lib ole32.lib winmm.lib dxguid.lib dinput.lib dsound.lib fmodvc.lib Ws2_32.lib ..\Debug\Out\FileSystem\vfs.lib /nologo /subsystem:windows /profile /machine:I386 /out:"..\Void.exe"
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib shell32.lib ole32.lib winmm.lib dxguid.lib dinput.lib dsound.lib fmodvc.lib Ws2_32.lib ..\Debug\Out\FileSystem\vfs.lib /nologo /subsystem:windows /debug /machine:I386 /out:"..\Void.exe"
