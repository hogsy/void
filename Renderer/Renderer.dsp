...
# ADD CPP /nologo /G5 /MDd /W3 /WX /GX /ZI /Od /I "..\Shared" /D "DYNAMIC_GL" /D "_DEBUG" /D "RENDERER" /D "_WIN32" /D "WIN32" /D "_WINDOWS_RENDERER" /D "RENDERER_EXPORTS" /Fr /YX"Standard.h" /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib shell32.lib ddraw.lib dxguid.lib d3dxd.lib d3dim.lib winmm.lib ole32.lib advapi32.lib ijl11.lib ..\Debug\vfs.lib /nologo /subsystem:windows /dll /debug /machine:I386 /out:"..\vrender.dll"
