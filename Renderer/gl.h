...
typedef	void (APIENTRY * GLFRUSTUM) (GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar);
...
typedef	const GLubyte * (APIENTRY * GLGETSTRING) (GLenum name);
...
typedef	void (APIENTRY * GLORTHO) (GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar);
...
extern	GLPOPMATRIX glPopMatrix;
extern	GLPUSHMATRIX glPushMatrix;
...
//========================================================
//Added GL Interface intialization

#define SZ_GLIDEDRIVER			"glide2x.dll"
#define SZ_3DFX_3DONLY_GLDRIVER	"3dfxvgl.dll"
#define SZ_3DFX_COMBO_GLDRIVER	"3dfxogl.dll"
#define SZ_NVIDIA_GLDRIVER		"nvopengl.dll"
#define SZ_NVIDIA_GLDRIVER_NT	"nvoglnt.dll"
#define SZ_MATROX_G200_GLDRIVER "g200icd.dll"
